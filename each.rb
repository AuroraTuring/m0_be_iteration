# As you complete each challenge, RUN THE CODE to ensure it works. You can do this by:
  ...
  # b. Running the file in your Terminal. You can do this by running `ruby <filepath>`. 
  #    If you are in this directory, you'd run `ruby each.rb`.
...
weather_options.each do |weather_option|
  puts "The current weather is #{weather_option}."
end
...
words.each do |word|
  if words.length = 3 
    puts "The words #{word} are exactly three characters in length."
  end
end


# Record yourself live-coding and talking through either Challenge 1 or 2. 
